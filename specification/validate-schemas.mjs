...
const metaAjv = new Ajv({ strict: "log", strictRequired: false, strictTypes: false, allErrors: true });
addFormats(metaAjv);
...
const compileAjv = new Ajv({ strict: "log", strictRequired: false, strictTypes: false, allErrors: true });
...
const refAjv = new Ajv({ strict: "log", strictRequired: false, strictTypes: false, allErrors: true });
addFormats(refAjv);
