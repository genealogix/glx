...
func generatePersonID(conv *ConversionContext) string {
	...
	return EntityIDPrefixPerson + strconv.Itoa(conv.PersonCounter)
}
...
func generateEventID(conv *ConversionContext) string {
	...
	return EntityIDPrefixEvent + strconv.Itoa(conv.EventCounter)
}
...
func generateRelationshipID(conv *ConversionContext) string {
	...
	return EntityIDPrefixRelationship + strconv.Itoa(conv.RelationshipCounter)
}
...
func generatePlaceID(conv *ConversionContext) string {
	...
	return EntityIDPrefixPlace + strconv.Itoa(conv.PlaceCounter)
}
...
func generateSourceID(conv *ConversionContext) string {
	...
	return EntityIDPrefixSource + strconv.Itoa(conv.SourceCounter)
}
...
func generateRepositoryID(conv *ConversionContext) string {
	...
	return EntityIDPrefixRepository + strconv.Itoa(conv.RepositoryCounter)
}
...
func generateMediaID(conv *ConversionContext) string {
	...
	return EntityIDPrefixMedia + strconv.Itoa(conv.MediaCounter)
}
...
func generateCitationID(conv *ConversionContext) string {
	...
	return EntityIDPrefixCitation + strconv.Itoa(conv.CitationCounter)
}
...
func generateAssertionID(conv *ConversionContext) string {
	...
	return EntityIDPrefixAssertion + strconv.Itoa(conv.AssertionCounter)
}
