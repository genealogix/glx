...
func TestE2E_GEDCOM551_Kennedy(t *testing.T) {
	gedcomPath := filepath.Join("..", "glx", "testdata", "gedcom", "5.5.1", "kennedy-family", "kennedy.ged")
	logPath := filepath.Join(t.TempDir(), "import.log")
...
func TestE2E_GEDCOM551_BritishRoyalty(t *testing.T) {
	gedcomPath := filepath.Join("..", "glx", "testdata", "gedcom", "5.5.1", "british-royalty", "british-royalty.ged")
	logPath := filepath.Join(t.TempDir(), "import.log")
...
func TestE2E_GEDCOM70_Maximal(t *testing.T) {
	gedcomPath := filepath.Join("..", "glx", "testdata", "gedcom", "7.0", "comprehensive-spec", "maximal70.ged")
	logPath := filepath.Join(t.TempDir(), "import.log")
...
func TestE2E_GEDCOM70_DateFormats(t *testing.T) {
	gedcomPath := filepath.Join("..", "glx", "testdata", "gedcom", "7.0", "date-formats", "date-all.ged")
	logPath := filepath.Join(t.TempDir(), "import.log")
...
func TestE2E_GEDCOM70_AgeValues(t *testing.T) {
	gedcomPath := filepath.Join("..", "glx", "testdata", "gedcom", "7.0", "age-values", "age-all.ged")
	logPath := filepath.Join(t.TempDir(), "import.log")
...
func TestE2E_GEDCOM70_SameSexMarriage(t *testing.T) {
	gedcomPath := filepath.Join("..", "glx", "testdata", "gedcom", "7.0", "same-sex-marriage", "same-sex-marriage.ged")
	logPath := filepath.Join(t.TempDir(), "import.log")
...
func TestE2E_AllFilesHaveRequiredStructure(t *testing.T) {
	...
	for _, tc := range testFiles {
		t.Run(tc.name, func(t *testing.T) {
			gedcomPath := filepath.Join("..", "glx", "testdata", "gedcom", tc.path)
			logPath := filepath.Join(t.TempDir(), "import.log")
