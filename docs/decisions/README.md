...
1. Copy [`0000-adr-template`](0000-adr-template.md) to `docs/decisions/NNNN-kebab-case-title.md`, where `NNNN` is the next unused 4-digit number.
...
See the [Contributing Guide](../../CONTRIBUTING.md#architecture-decision-records-adrs) for when an ADR is required versus when a regular issue or PR is sufficient.

## Index

| ADR | Title | Status |
| --- | --- | --- |
| [0001](0001-yaml-file-format.md) | Use YAML as the archive file format | Accepted |
| [0002](0002-evidence-first-data-model.md) | Separate Repository, Source, Citation, and Assertion entities | Accepted |
| [0003](0003-archive-owned-vocabularies.md) | Each archive owns its controlled vocabularies | Accepted |
| [0004](0004-git-native-archives.md) | Archives are Git repositories of plain-text files | Accepted |
| [0005](0005-flexible-entity-ids.md) | Flexible entity IDs, with 8-character hex as the recommended default | Accepted |
| [0006](0006-go-glx-library-pure.md) | The go-glx library never performs filesystem I/O | Accepted |
| [0007](0007-json-schema-2020-12.md) | JSON schemas use the 2020-12 dialect | Accepted |
