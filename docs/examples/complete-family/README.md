...
- `events/event-deaths.glx` - 3 death events
...
> **Learn More:** See [Core Concepts: Evidence Hierarchy](../../../specification/2-core-concepts.md#evidence-chain) for detailed explanation.
