...
## Verification
check: tidy-check tools-tidy-check lint test check-schemas check-drift-allowlist check-code-drift check-links validate-examples ## Run all checks (mirrors CI)
