# GENEALOGIX Makefile
.PHONY: help build build-cli build-website install-deps lint lint-fix test test-verbose test-coverage mod-tidy mod-verify clean fmt check-schemas check-links release-snapshot
