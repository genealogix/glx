...
> As of **2026-06-09**, GLX self-attests to the [OpenSSF OSPS Baseline](https://baseline.openssf.org/) version **2026.02.19** at **Level 2 (operationally mature)**, with most **Level 3 (mature)** controls also met. The single remaining gap is listed below and tracked as an open issue.
