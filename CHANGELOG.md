...
### Fixed
- **Summary shows marriages in chronological order** - `glx summary` now sorts spouses by marriage date (earliest first) instead of relationship ID order. Undated marriages sort after dated ones. The Life History narrative also reflects the correct marriage order. Fixes #136
