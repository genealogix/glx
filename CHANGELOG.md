...
- **Participant properties validated against event_properties vocabulary** - Properties on participants are validated using the same vocabulary as event-level properties
