...
#### GEDCOM Import
- **Auto-generate event titles** - Events imported from GEDCOM now receive human-readable titles (e.g., "Birth of Daniel Lane (1815)", "Marriage of John Smith and Jane Doe (1850)"). Falls back to Title Case for unlisted event types
...
- **Multi-family children placed in all matching families** - Children belonging to multiple FAM records (e.g., birth family + step-family) are now placed in all matching families on export instead of only the first match
